...
**Текущее состояние:** ширина по умолчанию 256, 1 200 656 параметров.
Скрипт нового эксперимента задаёт 50 000 обновлений; последний присланный
лог — шаг 11 000, VAL MSE=0.36021. Старый запуск ширины 128 и replay —
отдельные эксперименты. Все измерения и их ограничения собраны в
[RESULTS.md](RESULTS.md), краткий контекст — в [HANDOFF.md](HANDOFF.md).
